#property strict
#property copyright "TRIVIUM369 - EA_11_SENTIMENTO_MERCADO"
...
int OnInit() {
    Print("[EA_11_SENTIMENTO_MERCADO] ORQUESTRADOR CENTRAL - Arquitetura Correta");
...
void OnTick() {
    ...
    if(confluence >= ConfluenceMin) {
        ...
        if(trade.Buy(lot, _Symbol, entry, sl, tp, "EA_11_SENTIMENTO_MERCADO")) {
            tradesHoje++;
