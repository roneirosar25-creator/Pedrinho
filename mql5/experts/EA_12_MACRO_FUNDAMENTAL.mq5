#property strict
#property copyright "TRIVIUM369 - EA_12_MACRO_FUNDAMENTAL"
...
int OnInit() {
    Print("[EA_12_MACRO_FUNDAMENTAL] ORQUESTRADOR CENTRAL - Arquitetura Correta");
...
void OnTick() {
    ...
    if(confluence >= ConfluenceMin) {
        ...
        if(trade.Buy(lot, _Symbol, entry, sl, tp, "EA_12_MACRO_FUNDAMENTAL")) {
            tradesHoje++;
