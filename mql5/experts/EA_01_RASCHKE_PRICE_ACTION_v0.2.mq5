//+------------------------------------------------------------------+
//| EA_01_RASCHKE_PRICE_ACTION — v0.2 (REFORMULADO)                |
//| ✅ Integrado com: ACCOUNT_MANAGER, WHALE_DETECTOR, etc         |
...
#include "MQL5_INCLUDES_v0.1/ACCOUNT_MANAGER.mqh"
#include "MQL5_INCLUDES_v0.1/WHALE_DETECTOR.mqh"
#include "MQL5_INCLUDES_v0.1/RISK_MANAGEMENT.mqh"
#include "MQL5_INCLUDES_v0.1/CYCLE_ANALYTICS.mqh"
#include "MQL5_INCLUDES_v0.1/NEWS_CALENDAR.mqh"
...
int OnInit() {
    Print("[EA_01_v0.2] Iniciando em ", _Symbol, " | Magic=", MagicNumber);
    Print("[EA_01_v0.2] ✅ Integrado com ACCOUNT_MANAGER, WHALE_DETECTOR, RISK_MANAGEMENT");
...
void OnDeinit(const int reason) {
    ReleaseIndicators();
    Print("[EA_01_v0.2] Finalizado | Reason=", reason);
}
